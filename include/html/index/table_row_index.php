<tr>
    ...
    <td> <form method=post action='edit.php'> <input type="hidden" value="<?php echo htmlspecialchars($guest['id']); ?>" name=edit_id> <input type="hidden" name="message_invite" value="<?php echo htmlspecialchars($message_invite); ?>"> <input type="submit" value = Editer title="Editer l'invité <?php echo htmlspecialchars($guest['prenom'].' '.$guest['nom'])?>"> </form> </td>
    <td> <?php if ($guest['is_icam']==1 and ($message_invite[0]<$message_invite[2])){?> <form method=post action='secured/ajouter_invite.php'> <input type="hidden" value="<?php echo htmlspecialchars($guest['id']); ?>" name=add_id> <input type="hidden" name="add_invite" value=1 /> <input type="hidden" name="message_invite" value="<?php echo htmlspecialchars($message_invite); ?>"> <input type="submit" value = "Nouvel invité" title="Ajouter un invité à <?php echo htmlspecialchars($guest['prenom'].' '.$guest['nom'])?>"> </form> <?php } ?> </td>
</tr>